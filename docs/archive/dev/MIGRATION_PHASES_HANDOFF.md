...
When stopping work, add or update a dated manifest under [handoffs/](./handoffs/) (see `.cursor/skills/onex-handoff/SKILL.md`) with: branch, agents/skills/nodes touched, tests run, and the next **concrete** tasks (not “port more of omniclaude” unless scoped).
