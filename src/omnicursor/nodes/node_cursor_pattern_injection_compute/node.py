...
def run(prompt: str, patterns_file: Path, domain: str = "general") -> PatternInjectionOutput:
    return handle_pattern_inject(PatternInjectionInput(prompt=prompt, patterns_file=patterns_file, domain=domain))
